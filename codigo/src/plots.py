...
def plot_robot_stats(agent_stats: Mapping[str, Mapping]):
    stats_df = pd.DataFrame([s['robots_total'] for s in agent_stats])
    f, axes = plt.subplots(2, 2, figsize=(12, 8), sharex=True, sharey='row')
    axix = {
        'power': [0, 0],
        'ice': [1, 0],
        'ore': [0, 1],
